        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <p className="mt-3 text-sm sm:text-base text-slate-300 leading-relaxed max-w-md">
              Save your mock interviews, track progress over time, and get
              personalized preparation for every role you apply to.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
            <div className="rounded-xl border border-slate-800 bg-slate-900/60 px-4 py-3">
              ...
              <p className="text-slate-200">
                Practice interviews for software roles, internship rounds, and
                more.
              </p>
            </div>
            <div className="rounded-xl border border-slate-800 bg-slate-900/60 px-4 py-3">
              ...
              <p className="text-slate-200">
                Your scores, notes, and feedback stay synced across sessions.
              </p>
            </div>
          </div>

          <p className="text-xs text-slate-500">
            No long forms. Just sign up, pick a role, and start your first mock
            interview.
          </p>
        </div>
          ...
          <div className="relative rounded-2xl border border-slate-800 bg-slate-950/80 backdrop-blur-sm px-5 py-6 sm:px-7 sm:py-8 shadow-[0_18px_45px_rgba(15,23,42,0.75)]">
            <div className="mb-5">
              ...
              <p className="mt-1 text-xs sm:text-sm text-slate-400">
                Create your account to unlock AI-powered interviews and smart
                career tools.
              </p>
            </div>
              ...
              <SignUp
                ...
                appearance={{
                  variables: {
                    ...
                    colorPrimary: "#22c55e",
                    colorTextOnPrimaryBackground: "#0b1120",
                  },
                  elements: {
                    rootBox: "w-full",
                    ...
                    footerActionLink:
                      "text-emerald-400 hover:text-emerald-300 text-sm",
