...
// const handleUpgrade = () => {
//   router.push("/upgrade"); // 👈 redirects to /upgrade page
// };
...
export default function Sidebar() {
  ...
  return (
    <aside className="h-screen w-64 bg-[#0A1730] text-white flex flex-col justify-between fixed">
      {/* Top Section */}
      <div>
        {/* Logo */}
            ...
            return (
              <li key={navPath}>
                <Link href={navPath} passHref>
                  <div
                    className={`flex items-center justify-between px-5 py-3 cursor-pointer transition-all duration-300 ${active ? "bg-[#1E293B] text-yellow-300 font-semibold" : "hover:bg-[#1E293B]"
                      }`}
                  >
      ...
      <div className="p-5 space-y-4">
        ...
        <div className="bg-[#1E293B] rounded-lg p-4 text-center">
          ...
          {/* <button
            ...
            className="mt-3 w-full bg-yellow-400 text-black text-sm font-semibold py-1.5 rounded hover:bg-yellow-500 transition"
          >
            Upgrade
          </button> */}
          <Link
